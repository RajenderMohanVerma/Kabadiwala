...
import {
  ...
  CollectorDetailPage, CollectorHistoryPage, CollectorAvailabilityPage, CollectorRatingsPage, FaqPage, ContactPage, LegalPage
} from './pages'
...
function AppRoutes() {
  return <Routes>
    <Route element={<PublicLayout />}><Route path="/" element={<LandingPage />} /><Route path="/how-it-works" element={<PublicInfoPage kind="how" />} /><Route path="/impact" element={<PublicInfoPage kind="impact" />} /><Route path="/faq" element={<FaqPage />} /><Route path="/contact" element={<ContactPage />} /><Route path="/privacy-policy" element={<LegalPage kind="privacy" />} /><Route path="/terms-of-service" element={<LegalPage kind="terms" />} /></Route>
